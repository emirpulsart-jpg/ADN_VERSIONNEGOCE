...
export default function HomePage() {
  ...
  const getMultiplierAtY = (y: number) => {
    const yStart = pad + graphHeight * 0.75;
    if (y >= yStart) {
      const lossHeight = pad + graphHeight - yStart;
      const normalizedLoss = (y - yStart) / (lossHeight * visualScaleFactor);
      return Math.max(0.7, 1.0 - normalizedLoss * 0.30);
    }
    const growthHeight = yStart - pad;
    const normalizedGrowth = (yStart - y) / (growthHeight * visualScaleFactor);
    return 1.0 + normalizedGrowth * (maxValOfStock - 1.0);
  };

  const formatAxisMagnitude = (multiplier: number) => {
            ...
            {[0, 0.25, 0.5, 0.75, 1.0].map((ratio, i) => {
              ...
              return (
                <g key={i}>
                  ...
                  >
                    {formatAxisMagnitude(getMultiplierAtY(y))}
                  </text>
                </g>
              );
            })}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="space-y-4 font-sans text-sm text-slate-500 leading-relaxed">
                ...
                <div className="space-y-2 mt-8 lg:mt-14 pt-1">
                  ...
                  <p>
                    ...
                    >
                      document d&apos;information relatif aux risques particuliers dans le négoce des titres.
                    </a>
                  </p>
                </div>
              </div>
                    ...
                    <div className="absolute left-0 right-0 top-1/2 w-full">
                      ...
                      >
                        <div className="bg-emerald-50/60 border border-dashed border-[#10b981]/50 px-4 py-3 sm:px-5 sm:py-3.5 rounded-xl shadow-xs text-center shrink-0 w-[148px] sm:w-[165px]">
                          ...
                          <h4 className="font-adn-brand font-extrabold text-[10px] sm:text-xs uppercase tracking-wider text-swiss-navy whitespace-normal">ADN FINANCE SA</h4>
